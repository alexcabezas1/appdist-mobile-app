...
export default class Components extends React.Component {
  ...
  renderButtons = () => {
    return (
      <Block flex>
        <Text bold size={16} style={styles.title}>Pagina de Tarjetas</Text>
        <Text bold size={16} style={styles.title}>En esta pagina irá un boton que permitira cargar las tarjetas, y una lista de los tarjetas cargadas del usuario, que permitira ver el detalle y eliminar entradas. </Text>
